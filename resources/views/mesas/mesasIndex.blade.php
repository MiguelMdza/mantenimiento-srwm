    ...
    <body>
        ...
        <div class="container mt-2 pt-2">
            <div class="text-center">
                <h1 class="text-dark pt-3">Listado de Mesas</h1>         
            </div>

            <div class="text-left">
                <a class="btn custom-btn" href="/mesa/create">Agregar Mesa</a>
            </div>
                    ...
                    <table class="table-responsive-md table-bordered table">
                        <thead class="">
                            <tr class="text-center">
                                ...
                                <th scope="col">Mesero Atendiendo</th>
                        ...
                        <tbody>
                            <tr class="text-dark text-center">
                                ...
                                <!--LLAVES FORANEAS relación usuario-->
