...
<html lang="en">
    <head>
        ...
        <title>SRWM - Agregar Alimento</title>
                    ...
                    <div class="col-lg-5">
                        <div class="booking-form">
                            ...
                            <form action="/alimento" method="POST">
                                ...
                                <div class="control-group">
                                    <div class="input-group">
                                        <input type="number" step="0.01" min="0" max="9999" class="form-control" id="precio" name="precio" placeholder="Precio" value="{{ old('precio') }}" required="required" />
                                        <div class="input-group-append">
                                ...
                                <div class="control-group">
                                    <div class="input-group">
                                        <select class="custom-select form-control" name="tipo" id="tipo" value="{{ old('tipo') }}" required>
                                            <option selected disabled>Selecciona un tipo...</option>
                                            <option value="Bebida" class="text-dark">Bebida</option>
                                            <option value="Ensalada" class="text-dark">Ensalada</option>
                                            <option value="Sopa" class="text-dark">Sopa</option>
                                            <option value="Postre" class="text-dark">Postre</option>
                                            <option value="Aperitivo" class="text-dark">Aperitivo</option>
                                            <option value="Botana" class="text-dark">Botana</option>
                                            <option value="Plato Principal" class="text-dark">Plato Principal</option>
                                            <option value="Entrada" class="text-dark">Entrada</option>
                                        </select>
                                        <div class="input-group-append">
