                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5">
                        <div class="booking-form">
                            ...
                            <form action="/recurso/{{ $recurso->id }}" method="POST">
                            @csrf
                            @method('PATCH')
                                <div class="control-group">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" value="{{ $recurso->nombre }}" required="required" />
                                ...
                                <div class="control-group">
                                    <div class="input-group">
                                        <input type="text" step="0.01" min="0" max="9999" class="form-control" id="cantidad" name="cantidad" placeholder="Cantidad" value="{{ $recurso->cantidad }}" required="required" />
                                        <div class="input-group-append">
                                            <div class="input-group-text"><i class="far fa-envelope"></i></div>
                                        </div>
                                    </div>
                                ...
                                <div class="control-group">
                                    <div class="input-group">
                                        <input type="number" step="0.01" min="0" max="9999" class="form-control" id="costo" name="costo" placeholder="Costo" value="{{ $recurso->costo }}" required="required" />
                                        <div class="input-group-append">
                                            <div class="input-group-text"><i class="far fa-envelope"></i></div>
                                        </div>
                                    </div>
